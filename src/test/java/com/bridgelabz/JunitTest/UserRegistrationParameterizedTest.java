...
import com.bridgelabz.Junit.UserRegistrationJunit;
...
public class UserRegistrationParameterizedTest {
	...
	public UserRegistrationJunit userRegistrationJunit;
	...
	public void givenEmailAddress_ShouldReturnAsExpected() {
		boolean testResult = userRegistrationJunit.validateEmail(testEmail);
	...
	public static Collection input() {
		...
		return Arrays.asList(new Object[][] { { "abc@bridgelabz.co.in", true }, { "abc@gmail.com.com", true },
				...
				{ "abc", false }, { "abc@.com.my", false }, { "abc@abc@gmail.com", false },
